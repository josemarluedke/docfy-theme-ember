...
interface DocfyThemeSwitcherArgs {}
declare const FastBoot: unknown;

const DARK_MODE_CLASS = 'dark';

export default class DocfyThemeSwitcher extends Component<DocfyThemeSwitcherArgs> {
  @tracked prefersDark = false;

  constructor(owner: undefined, args: DocfyThemeSwitcherArgs) {
    super(owner, args);
